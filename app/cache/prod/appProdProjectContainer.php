...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/gca/Documents/workspace/expenseManager-symfony/app/cache/prod/annotations', false);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_fea5b6af3b3ba7f20607f90783c27f8aa2609a26e3a4cfaf10a2ccae635d005b');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_fea5b6af3b3ba7f20607f90783c27f8aa2609a26e3a4cfaf10a2ccae635d005b');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_fea5b6af3b3ba7f20607f90783c27f8aa2609a26e3a4cfaf10a2ccae635d005b');
        ...
        $d->setProxyDir('/Users/gca/Documents/workspace/expenseManager-symfony/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Users/gca/Documents/workspace/expenseManager-symfony/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/gca/Documents/workspace/expenseManager-symfony/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/gca/Documents/workspace/expenseManager-symfony/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Users/gca/Documents/workspace/expenseManager-symfony/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/gca/Documents/workspace/expenseManager-symfony/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/gca/Documents/workspace/expenseManager-symfony/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/gca/Documents/workspace/expenseManager-symfony/app/cache/prod',
            ...
            'session.save_path' => '/Users/gca/Documents/workspace/expenseManager-symfony/app/cache/prod/sessions',
            ...
            'router.resource' => '/Users/gca/Documents/workspace/expenseManager-symfony/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/gca/Documents/workspace/expenseManager-symfony/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/Users/gca/Documents/workspace/expenseManager-symfony/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Users/gca/Documents/workspace/expenseManager-symfony/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Users/gca/Documents/workspace/expenseManager-symfony/app/cache/prod/doctrine/orm/Proxies',
