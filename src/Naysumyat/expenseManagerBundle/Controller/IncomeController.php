...
use Naysumyat\expenseManagerBundle\Entity\Income;
use Naysumyat\expenseManagerBundle\Form\IncomeType;
...
class IncomeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NaysumyatexpenseManagerBundle:Income')->findAll();
     ...
     * @Method("POST")
     * @Template("NaysumyatexpenseManagerBundle:Income:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NaysumyatexpenseManagerBundle:Income')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("NaysumyatexpenseManagerBundle:Income:edit.html.twig")
     */
